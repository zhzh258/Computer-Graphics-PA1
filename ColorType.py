...
"""
I added __add__(), __sub__, __rmul__(), __floordiv__(), __truediv__ methods for the ColorType class.
This may increase code execution time.
"""
...
class ColorType:
    ...
    def __add__(self, other):
        return ColorType(self.r + other.r, self.g + other.g, self.b + other.b)
    ...
    def __rmul__(self, other):
        if isinstance(other, float) or isinstance(other, int):
            return ColorType(other * self.r, other * self.g, other * self.b)
        else:
    ...
    def __floordiv__(self, other):
        if isinstance(other, int):
            ...
            return ColorType(self.r // other, self.g // other, self.b // other)
